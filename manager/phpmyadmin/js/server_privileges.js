...
function checkPasswordStrength(value, meter_obj, meter_object_label, username) {
    ...
    switch (strength) {
        case 0:
            meter_obj_label.html(PMA_messages.strExtrWeak);
            break;
        case 1:
            meter_obj_label.html(PMA_messages.strVeryWeak);
            break;
        case 2:
            meter_obj_label.html(PMA_messages.strWeak);
            break;
        case 3:
            meter_obj_label.html(PMA_messages.strGood);
            break;
        case 4:
            meter_obj_label.html(PMA_messages.strStrong);
    }
}
